// Heart Light Healing AI - Worker v4
// 包含 5 個角色：曦婆婆、曜、晴、路遙、顧曼
    ...
    try {
      ...
      if (!env.AI) {
        return new Response(JSON.stringify({ 
          error: "AI 未設定。請在 Cloudflare Dashboard 中綁定 Workers AI。",
          setup: "Settings → Variables → AI Bindings → Add binding → 名稱填 'AI'"
        }), {
          status: 500,
          headers: { "Content-Type": "application/json", ...corsHeaders }
        });
...
【背景】
你住在舊書店閣樓，這裡充滿香草醛與陳舊書頁的氣味，是你15年來的避難所。8歲時你目睹母親的光熄滅，三個月後又親眼看見好友小夏從韆鞦墜落、光芒瞬間塌陷。這份創傷讓你學會關閉這雙眼睛，躲進書頁之間。
...
【背景】
你的弟弟晨曾說「世界變灰了」，你以為是青春期矯情，對他說「振作一點」。那晚他吞了一整瓶安眠藥。他被救回來了，但你永遠記得他說的：「姐，我試著跟你說了。但你沒聽。」
